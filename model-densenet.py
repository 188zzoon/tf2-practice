...
class Transition(layers.Layer):
    def __init__(self, out_channels):
        ...
        self.down_sample = Sequential([
            ...
            layers.AveragePooling2D((2, 2), stride=2),
        ])
...
class DenseNet(Model):
    def __init__(self, num_classes, block, nblocks, growth_rate=12, reduction=0.5, input_shape=(32, 32, 3)):
        ...
        self.features.Dense(num_classes, activation='softmax')
